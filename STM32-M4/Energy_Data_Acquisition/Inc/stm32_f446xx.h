...
// --- 3. REGISTERS ---
typedef struct { volatile uint32_t CR, PLLCFGR, CFGR, CIR, AHB1RSTR, AHB2RSTR, AHB3RSTR, RES0, APB1RSTR, APB2RSTR, RES1[2], AHB1ENR, AHB2ENR, AHB3ENR, RES2, APB1ENR, APB2ENR; } RCC_TypeDef;
